    ...
    <main className="landing-page">
      <header className="landing-header">
        <nav className="landing-nav" aria-label="Primary navigation">
          ...
          <div className="landing-nav__links"><a href="#experience">Experience</a><a href="#airports">Airports</a><a href="#how">How it works</a></div>
      ...
      <section id="top" className="landing-hero" aria-labelledby="landing-title">
        <div className="landing-hero__copy"><span className="landing-kicker"><i /> BUMBA GAMES ORIGINAL · RADAR STRATEGY</span><h1 id="landing-title">The sky is<br /><em>yours to</em><br />control.</h1><p className="landing-hero__lead">Manage live air traffic, make the right calls, protect safe separation and unlock new airports across your career map.</p><div className="landing-actions">{savedSession ? <button type="button" className="landing-primary" onClick={onResume}>RESUME SHIFT <small>Your saved session is ready</small></button> : null}<button type="button" className={savedSession ? 'landing-secondary' : 'landing-primary'} onClick={() => onStart(firstUnlocked)}>PLAY NOW <small>No account or password required</small></button></div><div className="landing-proof"><span>● NO PASSWORD</span><span>● WEB + MOBILE</span><span>● FREE TO START</span></div></div>
